...
def add_literature_command(
    ...
    openalex: Annotated[
        ...
        typer.Option(
            "--openalex",
            help=(
                "OpenAlex Work id (e.g. W2741809807). With --manual, stored as metadata; "
                "without --manual, fetched from the OpenAlex Works API."
            ),
        ),
    ] = None,
    ss: Annotated[
...
def _fetch_openalex_metadata(openalex: str) -> PaperMetadata:
